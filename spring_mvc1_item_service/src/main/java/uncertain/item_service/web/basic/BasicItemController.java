package uncertain.item_service.web.basic;
...
import uncertain.item_service.domain.item.Item;
import uncertain.item_service.domain.item.ItemRepository;
...
//    @PostMapping("/add")
    public String addItemV1(@RequestParam("itemName") String itemName, @RequestParam("price") int price, @RequestParam("quantity") Integer quantity, Model model) {
        Item saveItem = new Item(itemName, price, quantity);
